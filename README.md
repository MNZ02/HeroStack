...
`web/`, plus a storefront that showcases them. Every study ships with its own
...
The outer site. Lists every study with a captured preview, a filterable grid,
and a deep-linked detail panel. The only workspace here that isn't itself
a study.
...
effect behind pointer position.
...
### `web/deep-sea-jellybot`

Abyssal Medusa JX-7b. A robotic jellyfish drone styled as an engineering
datasheet — a wireframe membrane dome over stacked machinery plates, a
red-panelled utility spine and sixteen beaded actuator limbs, all generated
geometry living on a plotted-paper HUD of canvas gauges and leader-line
callouts. The whole body leans into a slow yaw like a specimen under glass.

The exploded view separates the assembly into its three core components —
neural dome, utility spine, propulsor limb — and the dome peels further into
